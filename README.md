...
About this project:
  ...
  3. Trained on tiny shakespeare dataset, see the "results" folder for more details. \
     ...
     After training on 100 epochs, training loss of Llama with ROPE is best, Llama HF is worst. In constrast, perplexity of Llama with ROPE is worst, Llama HF is best. Overfitting is occurred here, maybe caused by model complexity or lack of data to train.
